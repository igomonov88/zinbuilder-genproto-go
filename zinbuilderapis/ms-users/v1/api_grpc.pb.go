...
type UsersClient interface {
	...
	Watch(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (Users_WatchClient, error)
...
func (c *usersClient) Check(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
...
func (c *usersClient) Watch(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (Users_WatchClient, error) {
...
type UsersServer interface {
	...
	Watch(*HealthCheckRequest, Users_WatchServer) error
...
func (UnimplementedUsersServer) Check(context.Context, *HealthCheckRequest) (*HealthCheckResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Check not implemented")
}
func (UnimplementedUsersServer) Watch(*HealthCheckRequest, Users_WatchServer) error {
...
func _Users_Check_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsersServer).Check(ctx, req.(*HealthCheckRequest))
	}
